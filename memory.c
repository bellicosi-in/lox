...
void* reallocate(void* pointer,size_t oldSize, size_t newSize){
    ...
    //allocation is the nly tome when you reallyneed some free up memory so that you can reuse it.
    if(newSize > oldSize){
...
void markObject(Obj* object){
    ...
    //create a stack to keep track of the gray objects that we have traversed. the VM owns the gray stack = object;.
...
//traversing a single object's reference
...
//marking the roots. most roots are local variables or temporaries sitting right i the  VM's stack.
